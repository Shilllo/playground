import{a1 as x,i as O,r as W,a as I,x as b}from"./index-DQmy-DH5.js";import{n as w,c as M}from"./if-defined-BsTQyEV0.js";import"./index-7t1Whc-S.js";import{Q as N}from"./browser-CZueYgyP.js";const A=.1,k=2.5,$=7;function E(c,r,h){return c===r?!1:(c-r<0?r-c:c-r)<=h+A}function Q(c,r){const h=Array.prototype.slice.call(N.create(c,{errorCorrectionLevel:r}).modules.data,0),d=Math.sqrt(h.length);return h.reduce((p,u,f)=>(f%d===0?p.push([u]):p[p.length-1].push(u))&&p,[])}const D={generate({uri:c,size:r,logoSize:h,dotColor:d="#141414"}){const p="transparent",f=[],l=Q(c,"Q"),s=r/l.length,C=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];C.forEach(({x:o,y:t})=>{const n=(l.length-$)*s*o,e=(l.length-$)*s*t,a=.45;for(let i=0;i<C.length;i+=1){const g=s*($-i*2);f.push(x`
            <rect
              fill=${i===2?d:p}
              width=${i===0?g-5:g}
              rx= ${i===0?(g-5)*a:g*a}
