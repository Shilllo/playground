import{v as $,F as R,G as _,i as f,r as m,a as b,x as l,O as a,j as O}from"./index-B7qLn_8O.js";import{n as j,c as w,o as P,r as y}from"./if-defined-ko2469CF.js";import{e as T,n as U}from"./ref-Br-CNbh1.js";import{R as B}from"./ConstantsUtil-Dmg8YACJ.js";const u=$({isLegalCheckboxChecked:!1}),x={state:u,subscribe(n){return _(u,()=>n(u))},subscribeKey(n,e){return R(u,n,e)},setIsLegalCheckboxChecked(n){u.isLegalCheckboxChecked=n}},E=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
