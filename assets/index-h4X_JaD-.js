import{i as p,a as u,R as f,M as b,x as d}from"./index-BZBgGUqe.js";import{n as g,r as m,c as M}from"./if-defined-CdBzXU43.js";import{T as l}from"./index-YHtffsQh.js";const x={interpolate(i,e,o){if(i.length!==2||e.length!==2)throw new Error("inputRange and outputRange must be an array of length 2");const n=i[0]||0,r=i[1]||0,t=e[0]||0,s=e[1]||0;return o<n?t:o>r?s:(s-t)/(r-n)*(o-n)+t}},v=p`
  :host {
    width: 100%;
    display: block;
  }
