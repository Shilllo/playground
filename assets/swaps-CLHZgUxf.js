import{i as A,a as C,e as I,N as P,x as u,b as V,f as O,R as T,A as E,d as K,M,h as F,W as Q,r as q,j as H}from"./index-B4VgUxfj.js";import{r as s,n as h,c as D,U as x}from"./if-defined-DEdSnqwv.js";import"./index-MsYzC_Kj.js";import{M as N}from"./index-DzxUnuJS.js";import"./index-CTD-aIgC.js";import{S as i}from"./index-BGMbXsu0.js";import"./index-DrVx8_dw.js";import"./index-xfPgSnzh.js";import"./index-BhpjebVQ.js";import"./index-DnUyLGyk.js";import"./index-BVeXbFpI.js";import"./index-Dn3NHZt2.js";import"./ref-DPoHYI1y.js";const G={numericInputKeyDown(l,e,o){const n=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],a=l.metaKey||l.ctrlKey,t=l.key,r=t.toLocaleLowerCase(),c=r==="a",U=r==="c",W=r==="v",z=r==="x",j=t===",",L=t===".",R=t>="0"&&t<="9";!a&&(c||U||W||z)&&l.preventDefault(),e==="0"&&!j&&!L&&t==="0"&&l.preventDefault(),e==="0"&&R&&(o(t),l.preventDefault()),(j||L)&&(e||(o("0."),l.preventDefault()),(e?.includes(".")||e?.includes(","))&&l.preventDefault()),!R&&!n.includes(t)&&!L&&!j&&l.preventDefault()}},Y=A`
  :host {
    width: 100%;
  }
